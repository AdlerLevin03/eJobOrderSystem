...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($department_code)) {
        ...
        // Insert department
        try {
            $insert_query = "INSERT INTO departments (department_code, department_name, description, status, date_created) VALUES (?, ?, ?, ?, NOW())";
            $insert_stmt = $pdo->prepare($insert_query);
            $insert_stmt->execute([$department_code, $department_name, $description ?: null, $status]);
...
<head>
    ...
    <title>Add Department - Free WiFi Job Order System</title>
    <style>
        * {
            margin: 0;
            padding: 0;
        ...
        <div class="container">
            ...
            <form method="POST" action="">
                    ...
                    <div class="form-grid">
                        <div class="form-group">
                            ...
                            <input 
                                ...
                                value="<?php echo htmlspecialchars($_POST['department_code'] ?? ''); ?>"
                                maxlength="50"
                                required
                            >
                ...
                <div class="form-actions">
                    ...
                    <button type="submit" class="btn btn-submit">💾 Add Department</button>
                </div>
            </form>
        </div>
    </main>
