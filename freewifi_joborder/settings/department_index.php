...
try {
    ...
    $active_departments = count(array_filter($departments, fn($d) => $d['status'] === 'Active'));
    $inactive_departments = count(array_filter($departments, fn($d) => $d['status'] === 'Inactive'));
...
<head>
    ...
    <title>Departments - Free WiFi Job Order System</title>
    <style>
        * {
            margin: 0;
            padding: 0;
        ...
        <div class="container">
            ...
            <div class="stats-bar">
                <div class="stat-card">
                    ...
                    <div class="value"><?php echo htmlspecialchars($total_departments); ?></div>
                </div>
                <div class="stat-card active">
                    <p>Active Departments</p>
                    <div class="value"><?php echo htmlspecialchars($active_departments); ?></div>
                </div>
                <a href="department_inactive.php" class="stat-card inactive">
                    <p>Inactive Departments</p>
                    <div class="value"><?php echo htmlspecialchars($inactive_departments); ?></div>
                </a>
            </div>
            ...
            <?php if (count($departments) > 0): ?>
                <div class="search-section">
                    <a href="department_add.php" class="btn btn-add">+ Add New Department</a>
                    ...
                    <div class="search-results" id="searchResults">
                        Showing <?php echo count($departments); ?> departments
                    </div>
                </div>
            <?php else: ?>
                <a href="department_add.php" class="btn btn-add">+ Add New Department</a>
                        ...
                        <tbody>
                            <?php foreach ($departments as $department): ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span class="badge <?php echo ($department['status'] === 'Active') ? 'badge-success' : 'badge-inactive'; ?>">
            ...
            <?php else: ?>
                <div class="empty-state">
                    ...
                    <a href="department_add.php" class="btn btn-add">+ Add First Department</a>
                </div>
            <?php endif; ?>
        </div>
    </main>
    ...
    <script>
        ...
        if (searchInput) {
            searchInput.addEventListener('input', function() {
                ...
                if (searchTerm === '') {
                    searchResults.textContent = `Showing ${totalDepartments} departments`;
                ...
                if (visibleCount === 0 && searchTerm !== '') {
                    if (!noResultsDiv) {
                        ...
                        noResultsDiv.innerHTML = `
                            ...
                            <p>No departments match your search for "<strong>${this.value}</strong>"</p>
                        `;
