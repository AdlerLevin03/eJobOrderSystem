...
<head>
    ...
    <title>Clients - Free WiFi Job Order System</title>
    <style>
        * {
            margin: 0;
            padding: 0;
    ...
    <main>
        <div class="container">
            ...
            <div class="page-header">
                ...
                <p>View and manage all registered clients in the system</p>
            </div>
            ...
            <div class="stats-bar">
                <div class="stat-card">
                    <p>Total Clients</p>
                    <div class="value"><?php echo htmlspecialchars($total_clients); ?></div>
                </div>
                <div class="stat-card active">
                    <p>Active Clients</p>
                    <div class="value"><?php echo htmlspecialchars($active_clients); ?></div>
                </div>
                <a href="inactive.php" class="stat-card inactive">
                    <p>Inactive Clients</p>
                    <div class="value"><?php echo htmlspecialchars($inactive_clients); ?></div>
                </a>
            </div>
            ...
            <?php if (count($clients) > 0): ?>
                <div class="search-section">
                    <a href="add.php" class="btn btn-add">+ Add New Client</a>
                    ...
                    <div class="search-results" id="searchResults">
                        Showing <?php echo count($clients); ?> clients
                    </div>
                </div>
            <?php else: ?>
                <a href="add.php" class="btn btn-add">+ Add New Client</a>
                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <span class="badge <?php echo ($client['status'] === 'Active') ? 'badge-success' : 'badge-inactive'; ?>">
            ...
            <?php else: ?>
                <div class="empty-state">
                    ...
                    <a href="add.php" class="btn btn-add">+ Add First Client</a>
                </div>
            <?php endif; ?>
        </div>
    </main>
    ...
    <script>
        ...
        if (searchInput) {
            searchInput.addEventListener('input', function() {
                ...
                if (searchTerm === '') {
                    searchResults.textContent = `Showing ${totalClients} clients`;
                ...
                if (visibleCount === 0 && searchTerm !== '') {
                    if (!noResultsDiv) {
                        ...
                        noResultsDiv.innerHTML = `
                            ...
                            <p>No clients match your search for "<strong>${this.value}</strong>"</p>
                        `;
